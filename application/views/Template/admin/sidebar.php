  ...
  <div class="app-sidebar__user">
    ...
    <div class="app-sidebar__user-info">
      ...
      <?php
        ...
        ?>
      <p class="app-sidebar__user-designation"><?= $this->session->userdata('level') ?></p>
      <?php } ?>
      <?php
          if($this->session->userdata('level') == 'siswa') {
        ?>
      <p class="app-sidebar__user-designation" style="text-transform: uppercase;"><?= $this->session->userdata('kelas') ?> | <?= $this->session->userdata('jurusan') ?></p>
      <?php } ?>
